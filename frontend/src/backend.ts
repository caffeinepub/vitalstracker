...
export class Backend implements backendInterface {
    ...
    async addSimulatedReading(arg0: VitalsReading): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addSimulatedReading(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async addVitalsReading(arg0: number, arg1: number, arg2: number, arg3: number, arg4: number, arg5: number): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addVitalsReading(arg0, arg1, arg2, arg3, arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllReadings(): Promise<Array<VitalsReading>> {
        if (this.processError) {
            try {
    ...
    async getLatestReading(): Promise<VitalsReading> {
        if (this.processError) {
            try {
    ...
    async getReadingsByDateRange(arg0: Time, arg1: Time): Promise<Array<VitalsReading>> {
        if (this.processError) {
            try {
                const result = await this.actor.getReadingsByDateRange(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
